...
public class WorkLoggerDb {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        wdb.initialize();
        Work w = new Work("newlongcat", "workname", 3, LocalDate.now(), LocalDate.of(2026, 10, 2), 5, "S");
        System.out.println(w);
        wdb.insert(w, "work");
        wdb.selectOne(2, "work");
        System.out.println("All records");
        wdb.selectAll("work");
        Work change = new Work("newcategory", "newworkname", 300, LocalDate.now(), LocalDate.of(2026, 12, 22), 3, "S");
    ...
    //Select
    public Work selectOne(long id, String dbName) {
        ...
        try (Connection conn = DriverManager.getConnection(url);
            ...
            while (rs.next()) {
                ...
                Work selectedWork = new Work(sCategory, sName, sWeek, sAssignedDate, sDueDate, sDuration, sComplexity);
                selectedWork.id = sId;
    ...
    //Update
    public void update(long id, Work w) {
        String updateQuery = """
    ...
    public void completedWork(long id) {
        if (selectOne(id, "work") != null) {
            updateCompleted(id);
            Work selected = selectOne(id, "work");
